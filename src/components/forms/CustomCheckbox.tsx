...
export default function CustomCheckbox({ label, name }: CustomCheckboxProps) {
  return (
    <div className="border border-gray-200 rounded-sm dark:border-gray-700 pt-2.5 pb-1 px-2">
      <input id={`${label}-checkbox`} type="checkbox" name={name} value={label} className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 hover:cursor-pointer focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
